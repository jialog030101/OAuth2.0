	...
	sm.table = {
		...
		ajaxData :function () {
			...
			$.ajax({ 
	            ...
	            data : $.extend({}, sm.table.options.data, {current : sm.table.settings.current, size : sm.table.settings.size}),
	            async : false, 
	            cache : false,
	            dataType : "json",
	          	success : function(d){
		...
		createPagination :function () {
			...
			for( var i = 0, len = sm.table.options.pagination.sizes.length; i < len; i++){
				...
				html += '					<option	value="'+ $size +'" '+ ($size == sm.table.settings.size ? 'selected="selected"' : '')+ ' >'+ $size +'</option>';
			}
			html += '			</select> 条记录，</label>';
			html += '			<label>共&nbsp;' + sm.table.settings.total + '&nbsp;条记录</label>';
			html += '		</div>';
			html += '	</div>';
			html += '	<div class="col-xs-6">';
			html += '		<div id="' + tableId + '_paginate" class="dataTables_paginate paging_full_numbers">';
			html += '			<ul class="pagination">';
			html += '				<li id="' + tableId + '_first" class="paginate_button first ' + (sm.table.settings.current > 1 ? '' : 'disabled') + '" aria-controls="' + tableId + '" tabindex="0">';
			html += '					<a href="javascript:void(0)">首页</a>';
			html += '				</li>';
			html += '				<li id="' + tableId + '_previous" class="paginate_button previous ' + (sm.table.settings.current > 1 ? '' : 'disabled') + '" aria-controls="' + tableId + '" tabindex="0">';
			...
			if(sm.table.settings.current <= sm.table.settings.pages){
				...
				html += '					<a href="javascript:void(0)">' + sm.table.settings.current + '</a>';
				html += '				</li>';
			}
			...
			html += '				<li id="' + tableId + '_next" class="paginate_button next ' + (sm.table.settings.current < sm.table.settings.pages ? '' : 'disabled') + '" aria-controls="' + tableId + '" tabindex="0">';
			html += '					<a href="javascript:void(0)">下一页</a>';
			html += '				</li>';
			html += '				<li id="' + tableId + '_last" class="paginate_button last ' + (sm.table.settings.current < sm.table.settings.pages ? '' : 'disabled') + '" aria-controls="' + tableId + '" tabindex="0">';
